...
public class CompensationListener {
    ...
    public void handleCreationOutcome(Object event) {
        if (event instanceof ReportCreationFailedEvent failedEvent) {
            try {
        ...
        } else if (event instanceof ReportCreationConfirmationEvent confirmationEvent) {
